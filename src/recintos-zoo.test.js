...
describe('Recintos do Zoologico', () => {
    ...
    test('Não deve permitir mistura de carnívoros e herbívoros', () => {
    ...
    test('Deve encontrar recinto para 1 hipopótamo em recinto com outro animal', () => {
        const resultado = new RecintosZoo().analisaRecintos('HIPOPOTAMO', 1);
        expect(resultado.erro).toBeFalsy();
        expect(resultado.recintosViaveis.length).toBe(2); // Espera-se 2 recintos viáveis
